...
public class DodgeState_M : BaseState_M // TODO
{
    ...
    public DodgeState_M(BaseStateMachine_M _sm, string _animFwd, string _animBack, string _animLeft, string _animRight) : base(_sm)
    {
